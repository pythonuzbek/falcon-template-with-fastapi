  ...
  if (window.tinymce) {
    ...
    if (tinymces.length) {
      window.tinymce.init({
        ...
        statusbar: false,
        plugins: 'link,media,lists,table,media',
        toolbar: 'styleselect | bold italic link bullist numlist media blockquote table media undo redo',
